...
function firsttheme_setup() {
	...
	register_nav_menus( array(
        ...
        'menu-2' => esc_html__( 'Footer', 'firsttheme' ),
	) );
...
function firsttheme_scripts() {
    wp_enqueue_style( 'firsttheme-open-sans', '//fonts.googleapis.com/css?family=Open+Sans:300,400,600,700');
    wp_enqueue_style( 'firsttheme-raleway', '//fonts.googleapis.com/css?family=Raleway:400,500,600,700,800');
    wp_enqueue_style( 'firsttheme-lora', '//fonts.googleapis.com/css?family=Lora:400,400i');
    wp_enqueue_style( 'firsttheme-vendor-style', get_stylesheet_directory_uri() . '/css/vendor.css' );
    ...
    wp_enqueue_script( 'firsttheme-vendor', get_template_directory_uri() . '/js/vendor/vendor.min.js', array(), '', true );
    wp_enqueue_script( 'firsttheme-js', get_template_directory_uri() . '/js/main.js', array(), '20170305', true );
